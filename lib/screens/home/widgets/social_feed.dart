...
class SocialFeed extends StatelessWidget {
  ...
  static const List<_Post> _posts = [
    ...
    _Post(
      ...
      avatarColor: Color(0xFF7C6BE0),
      avatarImage: 'assets/images/influencers/influencer1.jpg',
      caption: "Omelette au fromage et avocat 🥑 Riche en bonnes graisses et en protéines, parfait pour bien démarrer la journée.",
      likes: 198,
      comments: 25,
      timeAgo: 'il y a 2 j',
      imageColors: [Color(0xFFF2994A), Color(0xFF35B8A6)],
      imageIcon: Icons.egg_alt,
      sponsored: false,
      postImages: ['assets/images/influencers/post_omelette.jpg'],
    ),
    _Post(
      user: 'dr.karim',
      avatarColor: Color(0xFF4C9BF5),
      avatarImage: 'assets/images/influencers/influencer2.jpg',
      caption: "Journée mondiale du don de sang 🩸 Une personne ne connaît peut-être pas votre nom, mais elle vivra grâce à votre don. Votre don fait la différence.",
      likes: 267,
      comments: 31,
      timeAgo: 'il y a 3 j',
      imageColors: [Color(0xFFEB5757), Color(0xFF4C9BF5)],
      imageIcon: Icons.bloodtype,
      sponsored: false,
      postImages: ['assets/images/influencers/post_blood_donation.jpg'],
    ),
    _Post(
      user: 'dr.sarah',
      avatarColor: Color(0xFFE57399),
      avatarImage: 'assets/images/influencers/influencer3.jpg',
      caption: "Octobre rose 🎀 Le dépistage précoce sauve des vies. Parlez-en à votre médecin et faites votre mammographie régulièrement.",
      likes: 312,
      comments: 47,
      timeAgo: 'il y a 4 j',
      imageColors: [Color(0xFFE57399), Color(0xFF7C6BE0)],
      imageIcon: Icons.favorite,
      sponsored: false,
      postImages: ['assets/images/influencers/post_pink_ribbon.jpg'],
    ),
    _Post(
      user: 'dr.karim',
      avatarColor: Color(0xFF4C9BF5),
      avatarImage: 'assets/images/influencers/influencer2.jpg',
      caption: "Que devez-vous savoir sur le diabète ? 🩺 Surveillez votre glycémie régulièrement et adoptez une alimentation équilibrée. Lisez la légende pour en savoir plus.",
      likes: 189,
      comments: 20,
      timeAgo: 'il y a 5 j',
      imageColors: [Color(0xFF4C9BF5), Color(0xFF35B8A6)],
